...
<br>
С помощью неё можно сравнивать цены на билеты, определять в какое время и каким классом дешевле лететь из одного города в другой. Осуществлять выборки в разрезе "сейчас", определять ближайший рейс. Вычислять расстояния, на которые могут лететь самолеты, имеющие заданную дальность полета. Определять самые популярные направления и востребованные рейсы.<br>
ER-диаграмма представлена ниже: <br>
